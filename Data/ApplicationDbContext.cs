...
namespace GoshehArtWebApp.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<Asset>().HasData(new Asset { Id = 1, Name = "Dans under Vita Lakan", Author = "Fateme Gosheh", Description = "Inte sett än", ImageUrl = Uri.EscapeDataString("/imagesAsset/Pictures/Sidans Filer/Filmproduktion/image (287).jpg"), CategoryId = 8 });
            modelbuilder.Entity<Asset>().HasData(new Asset { Id = 2, Name = "Aisha's Art", Author = "Fateme Gosheh", Description = "Gods butt from above", ImageUrl = Uri.EscapeDataString("/imagesAsset/Pictures/Sidans Filer/Kontroversiell Konst/image (3).jpg"), CategoryId = 6 });
            modelbuilder.Entity<Asset>().HasData(new Asset { Id = 3, Name = "Kari - Jag är elak", Author = "Fateme Gosheh", Description = "Helt fantastiskt", ImageUrl = Uri.EscapeDataString("/imagesAsset/Pictures/Sidans Filer/Filmproduktion/image (304).jpg"), CategoryId = 8 });
