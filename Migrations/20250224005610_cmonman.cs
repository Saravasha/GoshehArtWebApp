    ...
    public partial class cmonman : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fateme Gosheh", 8, "Inte sett än", "/imagesAsset/Pictures/Sidans Filer/Filmproduktion/image (287).jpg", "Dans under Vita Lakan" },
                    { 2, "Fateme Gosheh", 6, "Gods butt from above", "/imagesAsset/Pictures/Sidans Filer/Kontroversiell Konst/image (3).jpg", "Aisha's Art" },
                    { 3, "Fateme Gosheh", 8, "Helt fantastiskt", "/imagesAsset/Pictures/Sidans Filer/Filmproduktion/image (304).jpg", "Kari - Jag är elak" }
                });
