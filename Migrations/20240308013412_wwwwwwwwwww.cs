...
{
    /// <inheritdoc />
    public partial class wwwwwwwwwww : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fateme Gosheh", 1, "Inte sett än", "placeholder", "Dans under Vita Lakan" },
                    { 2, "Fateme Gosheh", 2, "Gods butt from above", "placeholder", "Aisha's Art" },
                    { 3, "Fateme Gosheh", 3, "Helt fantastiskt", "placeholder", "Kari - Jag är elak" }
                });
